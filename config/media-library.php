...
return [
     ...
     *
     * Va como CADENA y no como ::class porque Media Library Pro no está
     * instalado: la clase no existe en este proyecto. El valor de configuración
     * es idéntico, y así el análisis estático no tropieza con un símbolo que
